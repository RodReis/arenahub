...
| 2026-09-14 | #279 | — | unitário | 3415 | 3415 | 0 | 75.1 | — |
...
| 2026-09-25 | #400 | SPEC-021 | unitário | 3735 | 3735 | 0 | 74.6 | — |
| 2026-09-25 | #400 | SPEC-021 | integração | 1269 | 1267 | 2 | 80.9 | — — as 2 falhas são `platform-estatisticas-publicas.int-spec.ts` ("Unable to start a transaction"), que reprova também na `main` (conferido por `git stash`): a suíte soma todos os tenants e o banco de integração local acumula dados sem o reset (bloqueado para agente de IA). Não vêm desta entrega |
