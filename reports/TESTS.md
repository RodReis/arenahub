...
| 2026-09-12 | #25 | F25 | unitário | 3300 | 3300 | 0 | 74.8 | — — inclui os **10 testes** do `MobileFinanceiroService` (posse de invoice/tentativa/pagamento do aluno da sessão) e os **9 de tela/hook** do financeiro mobile (lista, cobrança PIX/checkout, polling de status) |
| 2026-09-12 | #25 | F25 | integração | 1088 | 1088 | 0 | 83.7 | — — **corrigido à mão**, mesma razão da F23/F24: o Jest crasha no Windows (exit 3221226505) e o gerador herda o número da entrega anterior (1079). A F25 acrescenta `mobile-financeiro.int-spec.ts` (74 suítes em disco, confirmado por `ls`), com **9 testes novos**: `1079 + 9 = 1088` |
