...
| 2026-09-04 | #270 | SPEC-060 | integração | 883 | 883 | 0 | 84.0 | — medido em lotes com `--json`, 57 suítes de `apps/api` (809) + 5 de `@arenahub/database` (74); o Jest crasha no fim no Windows e o gerador manteve o 824 herdado |
| 2026-09-04 | #270 | SPEC-060 | unitário | 2926 | 2926 | 0 | 75.4 | — |
| 2026-09-04 | #270 | SPEC-060 | integração | 887 | 887 | 0 | 84.0 | — medido em lotes com `--json`, 57 suítes de `apps/api` (813) + 5 de `@arenahub/database` (74); o Jest crasha no fim no Windows e o gerador herda o número anterior |
