...
**Canários (10):** teto sem `Math.abs` (3); categoria fora do `where` da regeneração (1);
...
`engagement.moderate` (1); `P2002` sem tradução (1).

**Evidência:** lint 10/10, typecheck 14/14, test 12/12 tasks sem cache (1265 API + 443 painel + 247
totem + 204 ui + 199 edge + 44 database); integração **732/732 em 48 suítes**, medida suíte a
