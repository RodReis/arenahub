...
**Última atualização:** 09/09/2026 *(F63 entregue — plano SaaS e contrato do tenant: o ArenaHub passa a saber quanto cobra de cada academia. Os valores do contrato são cópia do plano no fechamento, e alterar o catálogo não mexe em contrato vigente. O índice de correção acumula em vez de somar, e sem valor cadastrado a correção não roda — o painel diz quais competências faltam. Antes: F62 entregue — identidade visual do tenant e login por slug)*
...
| F64 | SPEC-064 | 7 | — | Fatura da plataforma sobre o tenant (inativo = todo status ≠ ACTIVE; emissão dia 1, configurável) | [`SPEC-064-fatura-da-plataforma.md`](specs/SPEC-064-fatura-da-plataforma.md) · [ADR-052](DECISIONS.md#adr-052) | [#287](https://github.com/RodReis/arenahub/issues/287) | 📋 **backlog** — spec `aprovada-pi` em 08/09/2026 |
