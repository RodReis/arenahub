...
| F61 | SPEC-061 | 7 | — | Super Admin e ciclo de vida do tenant (substitui o bootstrap por script) | [`SPEC-061-super-admin-e-ciclo-de-vida-do-tenant.md`](specs/SPEC-061-super-admin-e-ciclo-de-vida-do-tenant.md) · [ADR-052](DECISIONS.md#adr-052) | — | 📋 **rascunho** — decisões do PI em 08/09/2026; card a criar |
| F62 | SPEC-062 | 7 | — | Identidade visual do tenant (logo, ícone, nome, missão, diferenciais) e login por slug | [`SPEC-062-identidade-visual-do-tenant-e-login-por-slug.md`](specs/SPEC-062-identidade-visual-do-tenant-e-login-por-slug.md) · [ADR-052](DECISIONS.md#adr-052) | — | 📋 **rascunho** — decisões do PI em 08/09/2026; card a criar |
| F63 | SPEC-063 | 7 | — | Plano SaaS (por aluno ativo/inativo ou fixo corrigido por índice) e contrato imutável | [`SPEC-063-plano-saas-e-contrato.md`](specs/SPEC-063-plano-saas-e-contrato.md) · [ADR-052](DECISIONS.md#adr-052) | — | 📋 **rascunho** — decisões do PI em 08/09/2026; card a criar |
| F64 | SPEC-064 | 7 | — | Fatura da plataforma sobre o tenant — **bloqueada** pelas pendências 1–2 do ADR-052 | [`SPEC-064-fatura-da-plataforma.md`](specs/SPEC-064-fatura-da-plataforma.md) · [ADR-052](DECISIONS.md#adr-052) | — | 📋 **rascunho** — decisões do PI em 08/09/2026; card a criar |
| F65 | SPEC-065 | 7 | — | Gate de tenant no motor de decisão — carência 15 dias, razão `TENANT_SUSPENDED` | [`SPEC-065-gate-de-tenant-no-motor-de-decisao.md`](specs/SPEC-065-gate-de-tenant-no-motor-de-decisao.md) · [ADR-053](DECISIONS.md#adr-053) | — | 📋 **rascunho** — decisões do PI em 08/09/2026; card a criar |
| F66 | SPEC-066 | 7 | — | RLS fase 1 — role de runtime, `SET LOCAL` por transação, `students` e `audit_logs` | [`SPEC-066-rls-fase-1-role-de-runtime-e-primeiras-politicas.md`](specs/SPEC-066-rls-fase-1-role-de-runtime-e-primeiras-politicas.md) · [ADR-054](DECISIONS.md#adr-054) | — | 📋 **rascunho** — decisões do PI em 08/09/2026; card a criar |
| F67 | SPEC-067 | 7 | — | RLS fase 2 — `tenant_id` nas doze tabelas restantes e política em todas | [`SPEC-067-rls-fase-2-tenant-id-nas-tabelas-restantes.md`](specs/SPEC-067-rls-fase-2-tenant-id-nas-tabelas-restantes.md) · [ADR-054](DECISIONS.md#adr-054) | — | 📋 **rascunho** — decisões do PI em 08/09/2026; card a criar |
