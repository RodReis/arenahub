...
| F67 | SPEC-067 | 7 | — | RLS fase 2 — `tenant_id` nas doze tabelas restantes e política em todas | [`SPEC-067-rls-fase-2-tenant-id-nas-tabelas-restantes.md`](specs/SPEC-067-rls-fase-2-tenant-id-nas-tabelas-restantes.md) · [ADR-054](DECISIONS.md#adr-054) | [#290](https://github.com/RodReis/arenahub/issues/290) | 📋 **backlog** — spec `aprovada-pi` em 08/09/2026 |
