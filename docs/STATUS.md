...
| F57 | SPEC-057 | 1 | — | Dashboard operacional (nova porta de entrada do painel) | [`SPEC-057-dashboard-operacional.md`](specs/SPEC-057-dashboard-operacional.md) | [#242](https://github.com/RodReis/arenahub/issues/242) | ✅ **entregue** em 01/09/2026 — aguardando aceite. Os sete blocos num aceite só, com feriados dentro (F58 recusada pelo PI, número livre). Dois pedidos do PI entraram junto: **seletor de unidade** no topo (a troca estava adiada desde a F45, e sem ela não existe "hoje") e um **passe visual mais expressivo**, que emendou o `PRODUCT.md` e o `DS-PAINEL.md` §2.9/§2.10 |
