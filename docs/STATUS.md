...
**Última atualização:** 04/09/2026 *(F60 entregue; `[FIX]` #272 — assinatura duplicada inflava a receita esperada do painel financeiro; `[INFRA]` #274 — tela de usuários: convidar, listar e aceitar convite, que destrava criar administrador sem `curl`)*
