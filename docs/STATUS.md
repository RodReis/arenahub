...
**Última atualização:** 01/09/2026 *(F57 aprovada pelo PI — dashboard operacional, sete blocos num aceite só)*
...
| F57 | SPEC-057 | 1 | — | Dashboard operacional (nova porta de entrada do painel) | [`SPEC-057-dashboard-operacional.md`](specs/SPEC-057-dashboard-operacional.md) | [#242](https://github.com/RodReis/arenahub/issues/242) | **aprovada-pi** em 01/09/2026 — **depende de [#241](https://github.com/RodReis/arenahub/issues/241) item 6** (motivo de bloqueio/suspensão). Feriados **fica dentro da fatia**: F58 proposta pelo Cowork e **recusada pelo PI**, número não queimado |
