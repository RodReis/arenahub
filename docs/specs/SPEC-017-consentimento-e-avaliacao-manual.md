# SPEC-017 — Consentimento e avaliação manual

| campo | valor |
|---|---|
| **Fatia** | F17 |
| **MVP** | 3 |
| **Slice do PRD** | **3.1** — `docs/prd/academia/MVP-03-health-intelligence.md` §7 |
| **Plano de apoio** | `docs/superpowers/plans/2026-08-14-mvp-03-01-manual-assessments.md` |
| **Status** | `planejada` |
| **ADRs que bloqueiam** | nenhum |

> **Esta spec é um ponteiro (ADR-022).** O escopo, os requisitos (`M3-FR/BR/NFR/AC`) e os
> critérios de aceite **moram no PRD**, na Slice 3.1. Este arquivo não os copia — copiar cria
...
Ver `docs/prd/academia/MVP-03-health-intelligence.md` §7, Slice 3.1, e o plano de apoio acima.
