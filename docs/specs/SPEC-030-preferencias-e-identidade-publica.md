...
| **Fatia** | F30 |
| **MVP** | 5 |
| **Slice do PRD** | **5.1** — `docs/prd/academia/MVP-05-engagement.md` §7 |
| **Plano de apoio** | `docs/superpowers/plans/2026-08-14-mvp-05-01-preferences-public-identity.md` |
| **Status** | `planejada` |
...
Ver `docs/prd/academia/MVP-05-engagement.md` §7, Slice 5.1, e o plano de apoio acima.
