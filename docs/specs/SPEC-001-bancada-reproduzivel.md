# SPEC-001 — Bancada reproduzível

| campo | valor |
|---|---|
| **Fatia** | F1 |
| **MVP** | 0 |
| **Slice do PRD** | **0.1** — `docs/prd/academia/MVP-00-poc-topdata.md` §7 |
...
> critérios de aceite **moram no PRD**, na Slice 0.1. Este arquivo não os copia — copiar cria
...
Ver `docs/prd/academia/MVP-00-poc-topdata.md` §7, Slice 0.1, e o plano de apoio acima.
