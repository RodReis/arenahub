# SPEC-029 — Piloto e distribuição

| campo | valor |
|---|---|
| **Fatia** | F29 |
| **MVP** | 4 |
| **Slice do PRD** | **4.7** — `docs/prd/academia/MVP-04-app-totem.md` §7 |
| **Plano de apoio** | `docs/superpowers/plans/2026-08-14-mvp-04-07-pilot-distribution.md` |
| **Status** | `planejada` |
| **ADRs que bloqueiam** | nenhum |

> **Esta spec é um ponteiro (ADR-022).** O escopo, os requisitos (`M4-FR/BR/NFR/AC`) e os
> critérios de aceite **moram no PRD**, na Slice 4.7. Este arquivo não os copia — copiar cria
...
Ver `docs/prd/academia/MVP-04-app-totem.md` §7, Slice 4.7, e o plano de apoio acima.
