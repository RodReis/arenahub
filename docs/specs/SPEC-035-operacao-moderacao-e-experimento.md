...
> critérios de aceite **moram no PRD**, na Slice 5.6. Este arquivo não os copia — copiar cria
...
Ver `docs/prd/academia/MVP-05-engagement.md` §7, Slice 5.6, e o plano de apoio acima.
