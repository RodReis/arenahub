# SPEC-014 — Cartão e recorrência

| campo | valor |
|---|---|
| **Fatia** | F14 |
| **MVP** | 2 |
| **Slice do PRD** | **2.3** — `docs/prd/academia/MVP-02-smart-billing.md` §7 |
| **Plano de apoio** | `docs/superpowers/plans/2026-08-14-mvp-02-03-card-recurring.md` |
...
> critérios de aceite **moram no PRD**, na Slice 2.3. Este arquivo não os copia — copiar cria
...
Ver `docs/prd/academia/MVP-02-smart-billing.md` §7, Slice 2.3, e o plano de apoio acima.
