# SPEC-013 — PIX e webhook idempotente

| campo | valor |
|---|---|
| **Fatia** | F13 |
| **MVP** | 2 |
| **Slice do PRD** | **2.2** — `docs/prd/academia/MVP-02-smart-billing.md` §7 |
| **Plano de apoio** | `docs/superpowers/plans/2026-08-14-mvp-02-02-pix-webhooks.md` |
| **Status** | `em-revisao` |
| **ADRs que bloqueiam** | ADR-013 (provedor) |

> **Esta spec é um ponteiro (ADR-022).** O escopo, os requisitos (`M2-FR/BR/NFR/AC`) e os
> critérios de aceite **moram no PRD**, na Slice 2.2. Este arquivo não os copia — copiar cria
...
Ver `docs/prd/academia/MVP-02-smart-billing.md` §7, Slice 2.2, e o plano de apoio acima.
