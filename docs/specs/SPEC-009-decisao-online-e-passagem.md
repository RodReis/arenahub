# SPEC-009 — Decisão online e passagem

| campo | valor |
|---|---|
| **Fatia** | F9 |
| **MVP** | 1 |
| **Slice do PRD** | **1.4** — `docs/prd/academia/MVP-01-smart-access.md` §7 |
| **Plano de apoio** | `docs/superpowers/plans/2026-08-14-mvp-01-04-online-access.md` |
| **Status** | `aprovada-pi` |
| **ADRs que bloqueiam** | nenhum |

> **Esta spec é um ponteiro (ADR-022).** O escopo, os requisitos (`M1-FR/BR/NFR/AC`) e os
> critérios de aceite **moram no PRD**, na Slice 1.4. Este arquivo não os copia — copiar cria
...
Ver `docs/prd/academia/MVP-01-smart-access.md` §7, Slice 1.4, e o plano de apoio acima.
