# SPEC-003 — Catraca e passagem

| campo | valor |
|---|---|
| **Fatia** | F3 |
| **MVP** | 0 |
| **Slice do PRD** | **0.3** — `docs/prd/academia/MVP-00-poc-topdata.md` §7 |
...
> critérios de aceite **moram no PRD**, na Slice 0.3. Este arquivo não os copia — copiar cria
...
Ver `docs/prd/academia/MVP-00-poc-topdata.md` §7, Slice 0.3, e o plano de apoio acima.
