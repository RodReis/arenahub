...
| **Fatia** | F40 |
| **MVP** | 6 |
| **Slice do PRD** | **6.5** — `docs/prd/academia/MVP-06-retention-ai.md` §7 |
...
> critérios de aceite **moram no PRD**, na Slice 6.5. Este arquivo não os copia — copiar cria
...
Ver `docs/prd/academia/MVP-06-retention-ai.md` §7, Slice 6.5, e o plano de apoio acima.
